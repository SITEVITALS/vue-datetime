...
var script$3 = {
  ...
  computed: {
    ...
    minutes: function minutes$1 () {
      ...
      return minutes(this.minuteStep).filter(function (minute) { return minute % 15 == 0; }).map(function (minute) { return ({
        number: pad(minute),
